...
const Challenges: React.FC = () => {
  const challenges = [
    ...
    },
    {
      ...
      difficulty: 'Medium',
      description:
        "Print numbers 1-100, but replace multiples of 3 with 'Fizz', 5 with 'Buzz', and 15 with 'FizzBuzz'",
      completed: false,
    },
    {
      id: 4,
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center mb-2">
                  <h3 className="text-lg font-semibold text-gray-900 mr-3">{challenge.title}</h3>
                  <span
                    className={`px-2 py-1 text-xs font-medium rounded ${getDifficultyColor(challenge.difficulty)}`}
                  >
                    {challenge.difficulty}
                  </span>
                  {challenge.completed && <span className="ml-2 text-green-600">✓ Completed</span>}
                </div>
